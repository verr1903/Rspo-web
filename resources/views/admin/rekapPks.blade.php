        ...
        <div class="col-12">
          <div class="d-flex justify-content-end gap-2 flex-wrap">
            ...
            <div class="d-flex flex-column">
              ...
              <select class="form-select w-auto" id="namaPks">
                <option value="">-- Pilih PKS --</option>
                <option value="PKS A">PKS A</option>
                <option value="PKS B">PKS B</option>
                <option value="PKS C">PKS C</option>
              </select>
            </div>
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      <button class="me-1 btn btn-sm btn-warning" style="border-radius: 50%;" title="Edit"
                        data-bs-toggle="modal" data-bs-target="#editModal" data-tanggal="2025-08-28" data-pks="PTPN 5"
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="pks" value="PTPN 5">
                </div>
                <div class="mb-3">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Nomor Blanko PB 33</label>
