    ...
    <div class="card">
        ...
        <table>
            ...
            <tr>
                ...
                <td>{{ $kebun->nomor_blanko_pb25 }}</td>
            </tr>
            <tr>
                <th>Nopol Mobil</th>
                <td>{{ $kebun->nopol_mobil }}</td>
            </tr>
            <tr>
                <th>Nama Supir</th>
                <td>{{ $kebun->nama_supir }}</td>
            </tr>
        </table>
        ...
        <table style="width: 100%; margin-top: 20px; text-align: center;">
            <tr>
                <td style="text-align: center; vertical-align: top;">
                    ...
                    <img src="{{ public_path('storage/' . $kebun->foto_keseluruhan_kebun) }}"
                ...
                <td style="text-align: center; vertical-align: top;">
                    ...
                    <img src="{{ public_path('storage/' . $kebun->foto_sebelum_kebun) }}"
                        style="width: 150px; height: 150px; object-fit: cover; border-radius:5px; border:1px solid #ccc; display: block; margin: auto;">
                </td>
                <td style="text-align: center; vertical-align: top;">
                    <label style="display: block; font-weight: bold; margin-bottom: 5px;">Gambar 3</label>
                    <img src="{{ public_path('storage/' . $kebun->foto_sesudah_kebun) }}"
                        style="width: 150px; height: 150px; object-fit: cover; border-radius:5px; border:1px solid #ccc; display: block; margin: auto;">
                </td>
            </tr>
        </table>
